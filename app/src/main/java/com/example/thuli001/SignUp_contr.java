...
public class SignUp_contr extends AppCompatActivity implements View.OnClickListener {
    ...
    private void Sign(){
        ...
        {   mContactField.setError("Enter Contact");
            ...
            mAuth.createUserWithEmailAndPassword(useremail, password).addOnCompleteListener(SignUp_contr.this, new OnCompleteListener<AuthResult>() {
                @Override
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                        sendEmailVerification();
                    } else {
                        Toast.makeText(SignUp_contr.this, "Not successful", Toast.LENGTH_SHORT).show();
                    }
        ...
        if(firebaseUser!=null) {
            firebaseUser.sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if (task.isSuccessful()) {
                        sendUserData();
                        Toast.makeText(SignUp_contr.this, "Successfully verified ", Toast.LENGTH_SHORT).show();
                        finish();
                        startActivity(new Intent(SignUp_contr.this, Main2Activity.class));
            ...
            Toast.makeText(SignUp_contr.this, "Verify email", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.signup_link:{
                Intent I = new Intent(SignUp_contr.this, login_contr.class);
                startActivity(I);
                finish();
            }
        }
